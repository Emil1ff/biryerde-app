...
const App: React.FC = () => {
  return (
    // Wrap your entire navigation with the Redux Provider
    <Provider store={store}>
      <NavigationContainer>
        ...
        >
          ...
          <Stack.Screen name="MostPopularServices" component={PopularServices} />
          <Stack.Screen name="Filter" component={Filter} />
          <Stack.Screen name="AllServices" component={AllServices} />
          <Stack.Screen name="ServiceListByCategory" component={ServiceListByCategoryScreen} />
          <Stack.Screen name="ServiceDetail" component={ServiceDetailScreen} />
          <Stack.Screen name="AllPhotosAndVideos" component={AllPhotosAndVideosScreen} />
          <Stack.Screen name="AllReviews" component={AllReviewsScreen} />
          <Stack.Screen name="ServiceCustomization" component={ServiceCustomizationScreen} />
